...
using BananaModManager.Internals.SimpleJSON;
using System.Text.RegularExpressions;
using System.Drawing;

namespace BananaModManager
{
    public interface IFormMain1
    {
        object LightButton { get; }
    }

    public interface IFormMain2
    {
        object LightButton { get; }
    }

    [DebuggerDisplay("{" + nameof(GetDebuggerDisplay) + "(),nq}")]
    public partial class FormMain : Form, IFormMain, IFormMain1, IFormMain2
    {
        ...
        private void FormMain_Load(object sender, EventArgs e)
        {
            ...
            labelVersion.Text = "Banana Mod Manager v" + version.Substring(0, version.Length - 2);
        ...
        private void LoadReleases()
        {
            ...
            var decodedGroups = JSON.Parse(DownloadSite("https://raw.githubusercontent.com/DeveloperPixel0/BananaModInfo/refs/heads/master/modinfo.json"));
#else
        ...
        private void buttonFolderBrowser_Click(object sender, EventArgs e)
        {
            ...
            {
                fileDialog.FileName = "Capuchin.exe";
                fileDialog.Filter = "Exe Files (.exe)|*.exe|All Files (*.*)|*.*";
                fileDialog.FilterIndex = 1;
                if (fileDialog.ShowDialog() == DialogResult.OK)
                {
                    string path = fileDialog.FileName;
                    if (Path.GetFileName(path).Equals("Capuchin.exe"))
                    {
                    ...
                    {
                        MessageBox.Show("That's not Capuchin.exe! please try again!", "Error!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
        ...
        {
            Process.Start("https://discord.gg/tsqvjRVPWM");
        }
        ...
        public object LightButton { get; private set; }
        ...
        private void CheckVersion()
        {
            ...
            if (version > CurrentVersion)
            {
                this.Invoke((MethodInvoker)(() =>
                {
                    ...
                    Process.Start("https://github.com/DeveloperPixel0/BananaModManager/releases/latest");
                    Process.GetCurrentProcess().Kill();
                    Environment.Exit(0);
                }));
            }
        ...
        private void LocationHandler()
        {
            ...
            if (steam != null)
            {
                ...
                {
                    if (File.Exists(steam + @"\Capuchin.exe"))
                    {
        ...
        {
            Process.Start("https://discord.com/invite/capuchin");
        }
